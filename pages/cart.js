...
const Cart = ({ error, products }) => {
  ...
  const handleCheckout = async (paymentInfo) => {
    ...
    const res2 = await res.json();
    M.toast({ html: "order successful", classes: "green " });
    router.push("/");
  };
      ...
      >
        ...
        {products.length != 0 && (
          <StripeCheckout
            ...
            billingAddress={true}
            zipCode={true}
            stripeKey="pk_test_51KTiYRSEBxTP8I0FR9Ad8v2mmn0H4s09JtENXIA5YmIsHbUnrYC1cw4vPzwG0RJxKDIHxgHlAWrcfyWBecqOPlrb00oRGlRN6O"
